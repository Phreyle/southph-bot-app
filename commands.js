    ...
    },
    {
      ...
      options: [
        ...
        },
        {
          type: 3,
          name: 'role',
          description: 'The role slot to assign (ROA/GCAMPS/Tracking/Avadungeon use fixed roles, CTA/FF use categories)',
          required: true,
          choices: [
            ...
            { name: '🔮 Shadowcaller (ROA/GCAMPS/Avadungeon)', value: 'shadowcaller' },
            ...
            { name: '⚡ Stun (Avadungeon only)', value: 'stun' },
            ...
            { name: '🗡️ DPS2 (Avadungeon only)', value: 'dps2' },
            { name: '🗡️ DPS3 (Avadungeon only)', value: 'dps3' },
            { name: '🗡️ DPS4 (Avadungeon only)', value: 'dps4' },
          ],
        },
      ],
    },
